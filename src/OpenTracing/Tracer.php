...
use Yupao\Tracing\OpenTracing\InvalidSpanOptionException;
use Yupao\Tracing\OpenTracing\InvalidReferencesSetException;
...
interface Tracer
{
     ...
     *
     * It's also possible to not finish the {@see \Yupao\Tracing\OpenTracing\Span} when
     * {@see \Yupao\Tracing\OpenTracing\Scope} context expires:
     *
     ...
     * {@see \Yupao\Tracing\OpenTracing\ScopeManager::getActive()} span is used as `child_of`
     ...
     * @see \Yupao\Tracing\OpenTracing\StartSpanOptions
     */
